...
export function RobotFilters() {
  ...
  return (
    <div className="w-full space-y-3 sm:space-y-4">
      <div>
        <h2 className="text-xl sm:text-2xl font-bold text-foreground">Finde den perfekten Roboter</h2>
      ...
      <div className="w-full bg-card border border-border rounded-lg p-4 sm:p-6">
        <div className="space-y-4 sm:space-y-5">
          ...
          <Button
            ...
            className="w-full border-border text-foreground hover:bg-accent text-sm"
          >
            {isExpanded ? (
              <>
          ...
          {isExpanded && (
            <div className="space-y-4 sm:space-y-5 pt-2 border-t border-border">
